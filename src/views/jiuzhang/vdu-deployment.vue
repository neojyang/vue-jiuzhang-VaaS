<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Deployuid">
        <template slot-scope="scope">
          {{ scope.row.deployuid }}
        </template>
      </el-table-column>
      <el-table-column label="keyname" width="110" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.details.keyname }}</span>
        </template>
      </el-table-column>
      <el-table-column label="createdBy" width="110" align="center">
        <template slot-scope="scope">
          {{ scope.row.details.createdBy }}
        </template>
      </el-table-column>
      <el-table-column label="Tags" width="110" align="center">
        <template slot-scope="scope">
          {{ scope.row.details.Tags }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" prop="created_at" label="Display_time" width="200">
        <template slot-scope="scope">
          ...
          <span>{{ scope.row.details.createtime }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" prop="lastModified" label="Display_time" width="200">
        <template slot-scope="scope">
          <i class="el-icon-time" />
          <span>{{ scope.row.details.lastModified }}</span>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { fetchList } from '@/api/vdu-deployment'
  ...
  methods: {
    getList() {
      ...
      fetchList().then(response => {
        this.list = response.data.deploymentdatas
